...
You'll need to pass your sound card through to the Windows 10 virtual machine that you'll eventually be creating. In \
...
space. This will create a [thin-provisioned](https://en.wikipedia.org/wiki/Thin_provisioning) disk image for your VM: `qemu-img create -f qcow2 win10.qcow2 32G`
